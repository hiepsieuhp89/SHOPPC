...
if(isset($_POST["act"]))
{
	if(isset($_POST["capnhatgiohang"]))
	{
		...
		if(isset($_SESSION["user"]))
		{
			...
			{			
				if($sl[$i]<=0)
					$del=mysqli_query("delete from giohang where id='$id_form[$i]' and tinhtrang='themgiohang'");
				else{		
				$tt[$i]=$tong[$i]*$sl[$i];
