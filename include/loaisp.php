...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <?php     
		...
		if(isset($_GET["c"]))
		{	$kq=mysqli_query(include 'connect.php',"select count(*) from sanpham where id_loai=$id_loai and ghichu='hangdat'");		}
		else
	    {    $kq=mysqli_query(include 'connect.php',"select count(*) from sanpham where id_loai=$id_loai and (ghichu='hienthi' or ghichu='new')"); 	}
        $r=mysqli_fetch_array($kq);
        $numrow=$r[0];		
