		...
		while($r=mysqli_fetch_array($kq))
		{
				...
				{	while($r2=mysqli_fetch_array($kq2))
					{
						...
						$c1=mysqli_query(include 'connect.php',"select count(*) from sanpham where id_loai=$id_loai and (ghichu='hienthi' or ghichu='new')");
						$rc1=mysqli_fetch_array($c1);$nc1=$rc1[0];
			...
			else
			{
				...
				{	while($r2=mysqli_fetch_array($kq2))
					{
						$tenloai=$r2["tenloaisp"];$id_loai=$r2["id_loai"];	
						$c1=mysqli_query(include 'connect.php',"select count(*) from sanpham where id_loai=$id_loai");
						$rc1=mysqli_fetch_array($c1);$nc1=$rc1[0];
