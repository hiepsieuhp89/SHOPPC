...
<?php
	$idl=$_GET["idl"];
	$sql=mysqli_query("select nhomsanpham.*,loaisanpham.* from nhomsanpham,loaisanpham where nhomsanpham.id_nhom=loaisanpham.id_nhom and loaisanpham.id_loai=$idl");
