<?php
	$query=mysqli_query("select sanpham.*,hoadon.* from hoadon,sanpham where hoadon.id=sanpham.id");
...
<table width="735" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php
		$kq2=mysqli_query("select count(*) from hoadon where tinhtrang='damua'"); 
