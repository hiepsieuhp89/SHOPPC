...
<?php
		...
		if(isset($_REQUEST["idl"])){
	        $kq=mysqli_query("select count(*) from sanpham,loaisanpham where sanpham.id_loai=loaisanpham.id_loai and sanpham.id_loai=$idl"); }
		else{
	        $kq=mysqli_query("select count(*) from sanpham"); }
