...
//	echo "$sql";	
	...
	{
		$users=$r["user"];$ngaydat=ConvertDate_time_db($r["ngaydat"]);
		$hoten=$r["hoten"];$diachi=$r["diachi"];$email=$r["email"];$dt=$r["dienthoai"];
...
?>		
        ...
        <tr height="30">
            ...
            <td align="center" width="140" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong><a onmouseover="Tip('<?php echo "Họ tên: $hoten<hr>Địa chỉ: $diachi<hr>Email: $email<hr>Điện thoại: $dt"; ?>')"><?php echo "$users";?></a></strong></td>
            ...
            <td align="center" width="100" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong><br /><?php echo "$gia2 VND"; ?></strong></td> 
         </td>
 	 </tr>
